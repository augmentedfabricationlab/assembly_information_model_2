...
1. Fork `the repository <https://github.com/augmentedfabricationlab/assembly_information_model_2>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/assembly_information_model_2/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/assembly_information_model_2/issues>`_. If you are proposing a feature:
